...
class pontoEletronico extends TPage
{
    ...
    public function __construct( $param = null)
    {
        ...
        $button_entrar->setAction(new TAction([$this, 'onEntrada']), "Entrar");
        ...
        $button_entrar->addStyleClass('btn-default');
        ...
        $button_entrar->setImage('fas:door-open #000000');
        ...
        $row2 = $this->form->addFields([$button_entrar],[$button_2_pausa]);
